...
<div class="navigation">
	<ul>
    	<li><a href="./otherfacultyprofile.php">Faculty <br>Profile</a></li>
    	<li><a href="./addstdbyfaculty.php" class="active">Add Student Information</a></li>                                       
    </ul>
</div>
<div class="row text-center">
<div class="container">
<h1>Add Student Information</h1>
<form action="addstdbyfaculty.php" method="post">
<div class="row">
<div class="col-25">
...
header('Location: otherfacultylogin.php');
}else
{
